...
#define  GPIOA_ISK	          *((u32*)(GPIOA_BASE_ADDRESS + 0x18))

			/*  REGESTERS ADDRESSES FOR PORTB   */													
...
#define  GPIOB_ISK	          *((u32*)(GPIOB_BASE_ADDRESS + 0x18))
...
#define  GPIOC_ISK	          *((u32*)(GPIOC_BASE_ADDRESS + 0x18))
